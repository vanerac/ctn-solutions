...
export default function InvoiceForm({
    ...
    const [fields, setFields] = useState<Array<InvoiceField | null>>(invoice?.items || []);
        ...
        <div className="container mx-auto justify-center item-center">
            <form onSubmit={onFormSubmit}>
                <div className="card p-4">
                    <div className="text-3xl font-bold mb-2">Invoice Creation</div>
                    ...
                    <div className="my-4 border-b border-gray-200">
                        <div className="text-2xl font-bold">Invoice Items</div>
                        {
                            fields.map((item, index) => (
                                <>
                                    <div className="my-4 border-b border-gray-200"/>
                                    <InvoiceFormField formData={item} onChange={(data) => onFieldChange(index, data)}
