import {Company, Customer} from "../../../libs/SDK";
import Router from "next/router";

export default function CustomerDetails({customer, companyData}: { customer: Customer, companyData: Company }) {
    ...
    // Same style as the form in apps/web/pages/customers/new.tsx
    // Fields are readonly
    ...
    // Text fields should not be inputs
                        ...
                        <div className="px-4 py-5 sm:px-6">
                            ...
                            <div className="mt-5">
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        Router.push("/customers/" + customer.id + "/delete");
                                    }}
                                >
                                    Delete
                                </button>
